...
BEGIN
    CREATE TABLE dbo.surveys (
        ...
        TestURL         VARCHAR(MAX)    NULL,
        AccountManagerId INT            NULL,
        GroupSecurityId  INT            NULL,
        ClientId         VARCHAR(65)    NULL,
        ClientBillingPO  VARCHAR(65)    NULL,
        IsUniqueLinkSurvey SMALLINT     DEFAULT 0 NULL,
        IsCountryCheck   SMALLINT       DEFAULT 0 NULL,
        IsIpDuplicate    SMALLINT       DEFAULT 0 NULL,
        IsSpeederCheck   SMALLINT       DEFAULT 0 NULL,
        IsFilterDemographics SMALLINT   DEFAULT 0 NULL,
        IsVendorQuotaCheck   SMALLINT   DEFAULT 0 NULL,
        CreatedBy        INT            NULL,
        CreatedAt        DATETIME2(0)   NULL,
        Last_UpdatedBy   INT            NULL,
        Last_UpdatedAt   DATETIME2(0)   NULL,
        Survey_Closed_At DATETIME2(0)   NULL,
        SurveyType       SMALLINT       DEFAULT 0 NULL,
        IsActive         SMALLINT       DEFAULT 1 NULL,
        IsPickedNotified SMALLINT       DEFAULT 0 NULL,
        IsPickedDIY      SMALLINT       DEFAULT 0 NULL,
        PickedEmailTime  DATETIME2(0)   NULL,
...
BEGIN
    CREATE TABLE dbo.participants (
        ...
        IsRedirected    SMALLINT        DEFAULT 0 NULL,
        SurveyLoi       INT             NULL,
        SurveyIr        INT             NULL,
